    ...
    public partial class Form1 : Form
    {
        ...
        private void Calculate_button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (flag)
                {
                    if ((y >= 0 && x <= 2 && x >= -2 && y <= 4) || (y <= 0 && x <= 5 && x >= -4 && y >= -3)) Status.Text = "Принадлежит";
        ...
        {
            System.Diagnostics.Process.Start(@"C:\Users\Алина\Desktop\web\Стр.1.html");
            flag = true;
            Show_controls();
        }
        ...
        {
            System.Diagnostics.Process.Start(@"C:\Users\Алина\Desktop\web\Стр.2.html");
            flag = false;
            Show_controls();
        }
        ...
        {
            MessageBox.Show("Автор работы : Тимонина А.О. Пксп-117 Вариант №13");
        }
    }
}
